...
def plot_exp1_fanout_vs_duplication() -> None:
    ...
    plt.xlabel("Fanout")
    plt.ylabel("Average Propagation Rounds")
    ...
    plt.grid(True, alpha=0.3)
    save_plot("exp1_fanout_vs_transmissions.png")
    ...
    plt.grid(True, alpha=0.3)
    save_plot("exp1_fanout_vs_duplicates.png")
    ...
    plt.grid(True, alpha=0.3)
    save_plot("exp1_duplicate_ratio_vs_fanout.png")
...
def plot_exp3_topology_density_vs_performance() -> None:
    ...
    plt.grid(True, alpha=0.3)
    save_plot("exp3_density_vs_duplicate_ratio.png")
...
def plot_exp4_ch_overload_failure() -> None:
    ...
    plt.grid(True, alpha=0.3)
    save_plot("exp4_overload_vs_rounds.png")
