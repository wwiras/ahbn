...
def plot_exp07(csv_path: str) -> None:
    ...
    # Keep a stable plotting order if present
    ...
    timestamp = get_timestamp_from_csv_path(csv_path)
    ...
    out_3panel = f"outputs/plots/exp07_combined_3panel_{timestamp}.png"
    fig.savefig(out_3panel, dpi=150, bbox_inches="tight")
    plt.show()

    # -----------------------------
    # 2-panel figure (optional)
    # -----------------------------
    ...
    out_2panel = f"outputs/plots/exp07_combined_{timestamp}.png"
