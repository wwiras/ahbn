...
class AHBNParams:
    ...
    # --------------------------------------------------------
    # Provisional midpoint values because all controller
    # observations will be normalized to [0, 1].
    #
    # Final values will be selected/validated in Stage 0.
    d0: float = 0.5
    l0: float = 0.5
    u0: float = 0.5
    c0: float = 0.5
...
class AHBNController:
    ...
    def decide_mode_and_fanout(
        ...
        # -----------------------------------------
        #
        # beta controls how strongly Gossip
        # preference influences forwarding fanout.
        #
        # beta = 0:
        #     minimum fanout
        #
        # beta = 1:
        #     full linear response to controller
        #     weight
        #
        # beta > 1:
        #     stronger response, subject to bounds
        #
