...
LOG="${FORMAL_OUTPUT}/exp08_v063_analysis_terminal.log"
...
cd "${PROJECT_ROOT}"
echo "Analysis command: bash scripts/run_stage4_exp08_v063_analysis.sh ${1}"
echo "Selected dataset: ${FORMAL_OUTPUT}"
"${PYTHON}" scripts/analyze_stage4_exp08_v063.py "${FORMAL_OUTPUT}"
